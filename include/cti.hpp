...
std::valarray<std::valarray<double>> clock_charge_in_one_direction(
    ...
    int overscan = 0, int time_start = 0, int time_stop = -1,
    int print_inputs = -1);
...
std::valarray<std::valarray<double>> add_cti(
    ...
    int parallel_express = 0, int parallel_offset = 0, 
    int parallel_window_start = 0, int parallel_window_stop = -1,
    int parallel_overscan = 0, int parallel_time_start = 0, int parallel_time_stop = -1,
    // Serial
    ...
    int serial_overscan = 0, int serial_time_start = 0, int serial_time_stop = -1,
    int iteration = 0);
